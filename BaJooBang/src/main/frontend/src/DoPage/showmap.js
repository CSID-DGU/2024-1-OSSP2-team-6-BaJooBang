      ...
      <ol>
        {positions.map(position => (
          <li key={position.house_id}>
            ...
            <Link
              to={`/request/${position.house_id}?local_id=${position.local_id}`} // local_id를 쿼리 매개변수로 포함
              onClick={(e) => handleLinkClick(e, `/request/${position.house_id}?local_id=${position.local_id}`)} // 전체 경로를 전달
            >
